...
module Amos
  class EmbedConfirmCardPaymentMethodInput < ApiModelBase
    attr_accessor :type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Amos::EmbedConfirmCardPaymentMethodInput` initialize method"
      end
