...
module Amos
  class ConfirmSetupIntentWithEmbeddedPaymentMethodInput < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Amos::ConfirmSetupIntentWithEmbeddedPaymentMethodInput` initialize method"
      end
