...
module Amos
  class UpdatePaymentLinkRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        :'payment_link' => :'UpdatePaymentLinkInput'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Amos::UpdatePaymentLinkRequest` initialize method"
      end
