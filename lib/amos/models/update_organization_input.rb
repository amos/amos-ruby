...
module Amos
  class UpdateOrganizationInput < ApiModelBase
    # Globally unique public slug used in payment link URLs. Changing this breaks existing `/payment_links/{organization_slug}/...` links. 
    attr_accessor :slug
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Amos::UpdateOrganizationInput` initialize method"
      end
    ...
    def valid?
      ...
      return false if @slug !~ Regexp.new(/^[a-z0-9]+(?:-[a-z0-9]+)*$/)
      true
    end
