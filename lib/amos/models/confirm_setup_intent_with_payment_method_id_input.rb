...
module Amos
  class ConfirmSetupIntentWithPaymentMethodIdInput < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Amos::ConfirmSetupIntentWithPaymentMethodIdInput` initialize method"
      end
