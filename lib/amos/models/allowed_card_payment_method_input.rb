...
module Amos
  class AllowedCardPaymentMethodInput < ApiModelBase
    attr_accessor :type
    ...
    def self.openapi_types
      {
        :'type' => :'String',
        :'options' => :'AllowedCardPaymentMethodOptions'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Amos::AllowedCardPaymentMethodInput` initialize method"
      end
