...
module Amos
  class CreatePaymentLinkInput < ApiModelBase
    ...
    def hash
      [slug, active, amount_type, amount, image_url, minimum_amount, maximum_amount, suggested_amounts, currency, description, statement_descriptor, success_url, title, cancel_url, allowed_payment_methods, metadata].hash
    end
