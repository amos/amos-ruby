...
module Amos
  class AllowedGooglePayPaymentMethod < ApiModelBase
    attr_accessor :type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Amos::AllowedGooglePayPaymentMethod` initialize method"
      end
