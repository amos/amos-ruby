...
module Amos
  class CreateVoidInput < ApiModelBase
    ...
    # @param [Object] parent_transaction_id Value to be assigned
    def parent_transaction_id=(parent_transaction_id)
      if parent_transaction_id.nil?
        fail ArgumentError, 'parent_transaction_id cannot be nil'
      end
