...
module Amos
  class EmbedConfirmGooglePayPaymentMethodInput < ApiModelBase
    attr_accessor :type
    ...
    def self.openapi_types
      {
        ...
        :'card_profile_attributes' => :'GooglePayCardProfileInput'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Amos::EmbedConfirmGooglePayPaymentMethodInput` initialize method"
      end
      ...
      if attributes.key?(:'card_profile_attributes')
        ...
        self.card_profile_attributes = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @card_profile_attributes.nil?
        invalid_properties.push('invalid value for "card_profile_attributes", card_profile_attributes cannot be nil.')
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["googlepay"])
      return false unless type_validator.valid?(@type)
      return false if @card_profile_attributes.nil?
      true
    end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["googlepay"])
    ...
    # @param [Object] card_profile_attributes Value to be assigned
    def card_profile_attributes=(card_profile_attributes)
      if card_profile_attributes.nil?
        fail ArgumentError, 'card_profile_attributes cannot be nil'
      end
    ...
    def hash
      [type, metadata, billing_address_attributes, card_profile_attributes].hash
    end
