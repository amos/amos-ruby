...
module Amos
  # Apple Pay card profile for embed confirm. Clients must send the raw PKPaymentToken as wallet_payload; Vault decrypts it and returns the cryptogram. Encrypted PAN and client-supplied cryptogram are not supported. 
  class ApplePayCardProfileInput < ApiModelBase
    attr_accessor :wallet_brand

    # Display last4 from the Apple Pay payment method.
