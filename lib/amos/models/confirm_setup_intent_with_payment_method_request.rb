...
module Amos
  class ConfirmSetupIntentWithPaymentMethodRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        :'setup_intent' => :'ConfirmSetupIntentWithPaymentMethodInput'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Amos::ConfirmSetupIntentWithPaymentMethodRequest` initialize method"
      end
    ...
    def setup_intent=(setup_intent)
      if setup_intent.nil?
        fail ArgumentError, 'setup_intent cannot be nil'
      end
