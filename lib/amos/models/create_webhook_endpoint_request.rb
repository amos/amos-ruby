...
module Amos
  class CreateWebhookEndpointRequest < ApiModelBase
    ...
    # @param [Object] webhook_endpoint Value to be assigned
    def webhook_endpoint=(webhook_endpoint)
      if webhook_endpoint.nil?
        fail ArgumentError, 'webhook_endpoint cannot be nil'
      end
