...
module Amos
  class SubscriptionsApi
    ...
    def list_subscriptions_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListSubscriptions'
    ...
    # @param id [String] The ID of the subscription to skip billing periods for
    # @param skip_subscription_request [SkipSubscriptionRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Subscription]
    def skip_subscription(id, skip_subscription_request, opts = {})
      data, _status_code, _headers = skip_subscription_with_http_info(id, skip_subscription_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Subscription, Integer, Hash)>] Subscription data, response status code and response headers
    def skip_subscription_with_http_info(id, skip_subscription_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubscriptionsApi.skip_subscription ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SubscriptionsApi.skip_subscription"
      end
      # verify the required parameter 'skip_subscription_request' is set
      if @api_client.config.client_side_validation && skip_subscription_request.nil?
        fail ArgumentError, "Missing the required parameter 'skip_subscription_request' when calling SubscriptionsApi.skip_subscription"
      end
      # resource path
      local_var_path = '/subscriptions/{id}/skip'.sub('{id}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(skip_subscription_request)
      ...
      new_options = opts.merge(
        :operation => :"SubscriptionsApi.skip_subscription",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionsApi#skip_subscription\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # Update a subscription by ID
    # @param id [String] The ID of the subscription to update
    # @param update_subscription_request [UpdateSubscriptionRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Subscription]
    def update_subscription(id, update_subscription_request, opts = {})
      data, _status_code, _headers = update_subscription_with_http_info(id, update_subscription_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Subscription, Integer, Hash)>] Subscription data, response status code and response headers
    def update_subscription_with_http_info(id, update_subscription_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && update_subscription_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_subscription_request' when calling SubscriptionsApi.update_subscription"
      end
      # resource path
      local_var_path = '/subscriptions/{id}'.sub('{id}', CGI.escape(id.to_s))
