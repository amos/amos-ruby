...
module Amos
  class WebhookEndpointsApi
    ...
    # @option opts [Integer] :page The page of results to retrieve.
    # @option opts [Integer] :per_page Number of results per page.
    # @return [Array<(ListWebhookEndpoints, Integer, Hash)>] ListWebhookEndpoints data, response status code and response headers
    def list_webhook_endpoints_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListWebhookEndpoints'
    ...
    # @param [Hash] opts the optional parameters
    # @return [WebhookEndpoint]
    def update_webhook_endpoint(id, create_webhook_endpoint_request, opts = {})
      data, _status_code, _headers = update_webhook_endpoint_with_http_info(id, create_webhook_endpoint_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WebhookEndpoint, Integer, Hash)>] WebhookEndpoint data, response status code and response headers
    def update_webhook_endpoint_with_http_info(id, create_webhook_endpoint_request, opts = {})
      if @api_client.config.debugging
