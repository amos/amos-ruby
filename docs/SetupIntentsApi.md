...
> <SetupIntent> confirm_setup_intent(id, confirm_setup_intent_request)
...
confirm_setup_intent_request = Amos::ConfirmSetupIntentRequest.new({setup_intent: Amos::ConfirmSetupIntentInput.new}) # ConfirmSetupIntentRequest | 

begin
  # Confirm a setup intent
  result = api_instance.confirm_setup_intent(id, confirm_setup_intent_request)
  p result
...
> <Array(<SetupIntent>, Integer, Hash)> confirm_setup_intent_with_http_info(id, confirm_setup_intent_request)

```ruby
begin
  # Confirm a setup intent
  data, status_code, headers = api_instance.confirm_setup_intent_with_http_info(id, confirm_setup_intent_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SetupIntent>
rescue Amos::ApiError => e
...
| **confirm_setup_intent_request** | [**ConfirmSetupIntentRequest**](ConfirmSetupIntentRequest.md) |  |  |
...
api_instance = Amos::SetupIntentsApi.new
id = 'id_example' # String | The ID of the setup intent to confirm
confirm_setup_intent_with_payment_method_request = Amos::ConfirmSetupIntentWithPaymentMethodRequest.new({setup_intent: Amos::ConfirmSetupIntentWithPaymentMethodInput.new({payment_method: Amos::EmbedConfirmApplePayPaymentMethodInput.new({type: 'applepay', card_profile_attributes: Amos::CardProfileInput.new})})}) # ConfirmSetupIntentWithPaymentMethodRequest | 
