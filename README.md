...
```shell
gem install ./amos-0.11.0.gem
```

(for development, run `gem install --dev ./amos-0.11.0.gem` to install the development dependencies)
...
## Documentation for Models
 ...
 - [Amos::AllowedGooglePayPaymentMethod](docs/AllowedGooglePayPaymentMethod.md)
 - [Amos::AllowedGooglePayPaymentMethodInput](docs/AllowedGooglePayPaymentMethodInput.md)
 - [Amos::AllowedPaymentMethod](docs/AllowedPaymentMethod.md)
 - [Amos::AllowedPaymentMethodInput](docs/AllowedPaymentMethodInput.md)
 ...
 - [Amos::EmbedConfirmGooglePayPaymentMethodInput](docs/EmbedConfirmGooglePayPaymentMethodInput.md)
 - [Amos::EmbedConfirmPaymentMethodInput](docs/EmbedConfirmPaymentMethodInput.md)
 ...
 - [Amos::PaymentLinkAmountType](docs/PaymentLinkAmountType.md)
 - [Amos::PaymentMethod](docs/PaymentMethod.md)
 - [Amos::PaymentMethodType](docs/PaymentMethodType.md)
 - [Amos::Payout](docs/Payout.md)
 - [Amos::PayoutDirectionType](docs/PayoutDirectionType.md)
 - [Amos::PayoutStateType](docs/PayoutStateType.md)
 ...
 - [Amos::RefundStateType](docs/RefundStateType.md)
 ...
 - [Amos::SubscriptionIntervalType](docs/SubscriptionIntervalType.md)
 - [Amos::SubscriptionPlan](docs/SubscriptionPlan.md)
 - [Amos::SubscriptionPlanType](docs/SubscriptionPlanType.md)
 - [Amos::TransactionSourceType](docs/TransactionSourceType.md)
 ...
 - [Amos::WalletProviderType](docs/WalletProviderType.md)
 - [Amos::WebhookAttempt](docs/WebhookAttempt.md)
 - [Amos::WebhookEndpoint](docs/WebhookEndpoint.md)
 - [Amos::WebhookEventType](docs/WebhookEventType.md)
