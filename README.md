...
```shell
gem install ./amos-0.12.0.gem
```

(for development, run `gem install --dev ./amos-0.12.0.gem` to install the development dependencies)
...
## Documentation for Models
 ...
 - [Amos::ApplePayCardProfileInput](docs/ApplePayCardProfileInput.md)
 ...
 - [Amos::BillingAddressOptions](docs/BillingAddressOptions.md)
 ...
 - [Amos::PlaidCredentialsInput](docs/PlaidCredentialsInput.md)
 ...
 - [Amos::UsOnlyBillingAddressOptions](docs/UsOnlyBillingAddressOptions.md)
 - [Amos::UsStateType](docs/UsStateType.md)
 ...
 - [Amos::WebhookEventPayload](docs/WebhookEventPayload.md)
